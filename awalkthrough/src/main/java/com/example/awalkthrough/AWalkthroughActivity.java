...
import com.example.awalkthrough.views.CircleIndicatorView;

import java.util.List;

public abstract class AWalkthroughActivity extends AppCompatActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {

    private CircleIndicatorView circleIndicatorView;
    private ViewPager vpOnboarderPager;
    private AWalkthroughAdapter ahoyOnboarderAdapter;
    ...
    private List<AWalkthroughCard> pages;
    ...
    public void setOnboardPages(List<AWalkthroughCard> pages) {

        this.pages = pages;
        ahoyOnboarderAdapter = new AWalkthroughAdapter(pages, getSupportFragmentManager(), dpToPixels(0, this), typeface);
