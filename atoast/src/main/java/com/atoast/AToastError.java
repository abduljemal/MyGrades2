...
public class AToastError extends View {
    ...
    public AToastError(Context context) {
        super(context);
    }

    public AToastError(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AToastError(Context context, AttributeSet attrs, int defStyleAttr) {
