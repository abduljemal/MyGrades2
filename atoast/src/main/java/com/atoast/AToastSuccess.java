...
public class AToastSuccess extends View {
    ...
    public AToastSuccess(Context context) {
        super(context);
    }

    public AToastSuccess(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AToastSuccess(Context context, AttributeSet attrs, int defStyleAttr) {
