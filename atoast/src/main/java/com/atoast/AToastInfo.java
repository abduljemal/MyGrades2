...
public class AToastInfo extends View {
    ...
    public AToastInfo(Context context) {
        super(context);
    }


    public AToastInfo(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AToastInfo(Context context, AttributeSet attrs, int defStyleAttr) {
