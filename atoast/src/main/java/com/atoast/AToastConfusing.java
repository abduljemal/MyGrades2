...
public class AToastConfusing extends View {
    ...
    public AToastConfusing(Context context) {
        super(context);
    }

    public AToastConfusing(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AToastConfusing(Context context, AttributeSet attrs, int defStyleAttr) {
