...
public class AToastDefault extends View {
    ...
    public AToastDefault(Context context) {
        super(context);
    }

    public AToastDefault(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AToastDefault(Context context, AttributeSet attrs, int defStyleAttr) {
