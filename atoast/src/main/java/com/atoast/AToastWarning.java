...
public class AToastWarning extends View {
        ...
        public AToastWarning(Context context) {
            super(context);
        }


        public AToastWarning(Context context, AttributeSet attrs) {
            super(context, attrs);
        }

        public AToastWarning(Context context, AttributeSet attrs, int defStyleAttr) {
